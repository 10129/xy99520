...
public class ActivitiEngineConfiguration {
  ...
  public DataSource dataSource() { 
    ...
    // Connection settings
    ds.setUrl(environment.getProperty("jdbc.url", "jdbc:mysql://localhost:3306/activiti"));
    ds.setUsername(environment.getProperty("jdbc.username", "root"));
    ds.setPassword(environment.getProperty("jdbc.password", "root"));
