package com.hand.xy99.weixin.test.entp;

/**
 * Created by xieshuai on 2018/1/24.
 */
...
//        String accessToken= WeiXinUtil.getAccessToken(WeiXinParamesUtil.corpId, WeiXinParamesUtil.contactsSecret).getAccessToken();
