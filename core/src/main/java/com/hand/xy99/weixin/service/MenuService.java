...
import com.hand.xy99.weiapi.menu.*;
...
*/
		...
		CommandButton btn25 = new CommandButton();
		btn25.setName("聊天唠嗑");
		btn25.setType("click");
		btn25.setKey("25");

		CommandButton btn31 = new CommandButton();
		btn31.setName("Q友圈");
		btn31.setType("click");
		btn31.setKey("31");

		CommandButton btn33 = new CommandButton();
		btn33.setName("幽默笑话");
		btn33.setType("click");
		btn33.setKey("33");

		CommandButton btn34 = new CommandButton();
		btn34.setName("用户反馈");
		btn34.setType("click");
		btn34.setKey("34");

		CommandButton btn35 = new CommandButton();
		btn35.setName("关于我们");
		btn35.setType("click");
		btn35.setKey("35");
