...
databaseChangeLog(logicalFilePath: "com/hand/xy99/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate(dbType, ["com/hand/xy99"], ["table", "data", "patch"])
